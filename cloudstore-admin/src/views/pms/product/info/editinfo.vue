        ...
        <el-form :inline="true" :model="baseinfo" ref="baseinfo" size="small" label-width="130px" :rules="rules">
          ...
          <el-form-item label="商品标题图片(只有1个)：" prop="goodsPics">
            <div v-if="rwDispatcherState =='read'">
              <el-image v-for=" (item,index) in goodsPics" :src="item.url" :key='index'
                        style="width: 150px; height: 150px;margin-right: 20px;" v-model="baseinfo.goodsPics">
          ...
          <el-form-item label="商品详情图片(最多5个)：" prop="goodsDetailPics">
            <div v-if="rwDispatcherState =='read'">
              <el-image v-for=" (item,index) in goodsDetailPics" :src="item.url" :key='index'
                        style="width: 150px; height: 150px;margin-right: 20px;" v-model="baseinfo.goodsDetailPics">
                <div slot="placeholder" class="image-slot">
                  加载中<span class="dot">...</span>
                </div>
              </el-image>
          ...
          <el-form-item prop="categoryTwoId">
            <el-select-dispatcher v-model="baseinfo.categoryTwoId" :options="category1" remote
                                  v-on:change="seclectCategory($event, 2)"
          ...
          <el-form-item prop="categoryThreeId">
            <el-select-dispatcher v-model="baseinfo.categoryThreeId" :options="category1" remote
                                  v-on:change="seclectCategory($event, 3)"
          ...
          <el-form-item label="地区：" prop="provinceId">
            <el-select-dispatcher v-model="baseinfo.provinceId" :options="category1" remote placeholder="省"
                                  :loading="loading"
          ...
          <el-form-item prop="cityId">
            <el-select-dispatcher v-model="baseinfo.cityId" :options="category1" remote placeholder="市"
                                  :loading="loading"
          ...
          <el-form-item prop="areaId">
            <el-select-dispatcher v-model="baseinfo.areaId" :options="category1" remote placeholder="区/县"
                                  :loading="loading"
