<template>
  <div class="app-container">
    ...
    <el-form :model="goodsku" ref="brokeRules" :rules="rules" label-width="150px" size="small">
      <div>
        <el-table style="width: 100%;margin-top: 20px" :data="goodsku.skuStockList" border>
          ...
          <el-table-column label="SKU编号" align="center" prop="goodsSkuBean.skuCode" width="150">
          </el-table-column>
          <el-table-column :label='specslabel'  align="center" prop="goodsSkuBean.skuValue" width="100">
          </el-table-column>
          <el-table-column label="SKU原价" align="center" prop="goodsSkuBean.price" width="100">
          </el-table-column>
    ...
    <div style="width: 100%;text-align:center">
      <br /> <br /> <br /> <br />
      <el-button style="margin-bottom: 10px;" type="primary" @click="updateGoodsProperties('brokeRules')" size="small" v-if="powershowing(power.hotSale_submit)">
        提 交
      </el-button>
        ...
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
            this.$confirm('确定要提交吗?', '提示', {
              ...
              obj.agent = this.goodsku.skuStockList[0].agent;
              obj.client = this.goodsku.skuStockList[0].client;
              obj.clientPoints = this.goodsku.skuStockList[0].clientPoints;
              obj.delivery = this.goodsku.skuStockList[0].delivery;
