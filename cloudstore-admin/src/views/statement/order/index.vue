  ...
  export default {
    ...
    methods: {
      ...
      getList(obj) {
        ...
        this.lineOne = [];
        this.lineTwo = [];
        showcharts(obj).then(res => {
          if (res.result.code == 0) {
            let data = res.result.result.saleMoneys;
            let dataArr = res.result.result.saleOrders;
            this.orderNumber = res.result.result.moneys;
            this.sale = res.result.result.orders;
