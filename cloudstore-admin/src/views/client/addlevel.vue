    ...
    <el-card class="filter-container" shadow="never">
      ...
      <el-form :inline="true" :model="userForm" size="small" label-width="130px" style="margin-top: 20px" ref="userForm" :rules="rules">
        ...
        <el-form-item label="客户等级：" prop="level">
          <el-input-dispatcher style="width: 214px" v-model="userForm.phone" placeholder="客户等级"></el-input-dispatcher>
        </el-form-item>
        <br />
  ...
  export default {
    ...
    created() {
      switch (this.$route.query.operaType){
        case "add": this.titMsg = "添加等级";
          break;
        case "read": this.titMsg = "查看等级";
          break;
        case "edit": this.titMsg = "编辑等级";
          break;
      }
