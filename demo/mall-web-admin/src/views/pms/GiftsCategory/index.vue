...
<script>
    import {fetchList, deleteGiftsCategory} from '@/api/pms/GiftsCategory'
    ...
    export default {
        ...
        data() {
            return {
                operates: [
                    {
                        label: "显示品牌",
                        value: "showGiftsCategory"
                    },
                    {
                        label: "隐藏品牌",
                        value: "hideGiftsCategory"
                    }
                ],
                operateType: null,
                listQuery: {
        ...
        methods: {
            ...
            handleUpdate(index, row) {
                this.$router.push({path: '/pms/updatePmsGiftsCategory', query: {id: row.id}})
            },
