  ...
  <div class="app-container" style="position: relative; height: calc(100vh - 117px);">
    <div class="container">
      ...
      <el-tabs v-model="status" type="card" @tab-click="handleOrder">
        ...
        <el-tab-pane name="13">
          <span slot="label"><i class="el-icon-back"></i> 申请退款</span>
        </el-tab-pane>
        <el-tab-pane name="14">
     ...
     <el-card class="filter-container" shadow="never">
      ...
      <div class="order-caculate">
        <a class="caculate-title">订单数 : <span class="caculate-num">{{caculateInfo.orderCount}}</span></a>

        <a class="caculate-title">订单金额 : <span class="caculate-num">{{caculateInfo.orderPay}}</span></a>
        <a class="caculate-title">客户数 : <span class="caculate-num">{{caculateInfo.memberCount}}</span></a>
      </div>
...
<script>
 ...
 checkPermission,
      ...
      downloadMethod() {
            ...
            download(process.env.BASE_API + '/download', this.params).then(result => {
