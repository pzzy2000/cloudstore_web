        ...
        <el-card class="filter-container" shadow="never">
            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
                    ...
                    <el-form-item label="输入搜索订单编号：">
                        <el-input style="width: 203px" v-model="listQuery.orderId" placeholder="订单编号"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        </el-card>
...
<script>
    import {fetchList,deleteGifts} from '@/api/pms/productConsult'
        ...
        methods: {
            ...
            handleDelete(index, row) {
                this.$confirm('是否要删除该评论', '提示', {
                    ...
                    deleteGifts(row.id).then(response => {
                    this.$message({
                    message: '删除成功',
                    type: 'success',
                    duration: 1000
